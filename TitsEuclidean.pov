...
#declare ecol = Yellow;
#declare edgeColors = array[3]{ ecol, ecol, ecol };
#declare facefilter = 0.5;
#declare faceColors = White*0.6;
#declare faceColorsDimmed = faceColors * 0.3;
...
#macro faceTexture(ind, faceType)
  #if(faceType)
    #local col = faceColors;
  #else
    #local col = faceColorsDimmed;
  #end
